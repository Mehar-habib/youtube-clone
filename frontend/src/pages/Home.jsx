...
//   const categories = [
//     "Music", "Movies", "Gaming", "News", "Sports", "Education", "Comedy", "Vlogs", "Science & Tech", "Entertainment", "Art", "Pets", "Cooking", "Fashion", "Travel",
//   ]
//   return (
...
//       {/* sidebar */}
//       <aside className={`bg-{#0f0f0f} border-r border-gray-800 fixed top-[60px] z-40 bottom-0 transition-all ${sidebarOpen ? "w-60" : "w-20"} hidden md:flex flex-col overflow-y-auto`}>
//     <nav>
...
// <nav>
//   {sidebarOpen && <p>You</p>}
//   <SidebarItem icon={<MdHistory />} text="History" open={sidebarOpen} selected={selectedItem === "History"} onClick={() => setSelectedItem("History")} />
//       <SidebarItem icon={<MdOutlinePlaylistPlay  />} text="Playlist" open={sidebarOpen} selected={selectedItem === "Playlist"} onClick={() => setSelectedItem("Playlist")} />
...
// <hr />
// {sidebarOpen && <p>Subscriptions</p>}
//       </aside>

//       {/* main area */}
//       <main className={`overflow-y-auto p-4 flex flex-col pb-16 transition-all duration-300 ${sidebarOpen ? "mid:ml-60" : "md:ml-20"}`}>
//       {location.pathname === "/" && (
//         <>
...
//   return(
//     <button onClick={onClick} className={`flex flex-col items-center justify-center gap-1 px-2 sm:px-3 ${active ? "text-white":"text-gray-400"} hover:scale-105`} >
//       <span>{icon}</span>
//       {text && <span>{text}</span>}
//     </button>
//   )
